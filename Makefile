...
pkgdatadir = $(datadir)/dd2
pkglibdir = $(libdir)/dd2
pkgincludedir = $(includedir)/dd2
...
EXTRA_DIST = snapshot-sh AUTHORS COPYING NEWS README TODO ChangeLog

docsdir = $(datadir)/doc/$(PACKAGE)
docs_DATA = AUTHORS COPYING NEWS README TODO ChangeLog
...
.PHONY: uninstall-docsDATA install-docsDATA install-data-recursive \
